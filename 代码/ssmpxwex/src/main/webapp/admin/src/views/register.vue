  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(229, 238, 229, 0.07);borderRadius:10px">
        <h1 class="h1" style="color:rgba(24, 103, 228, 1);fontSize:28px;">农场驿站平台小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.maijiazhanghao" class="input" type="text" placeholder="卖家账号">
			   </div>
			 </div> -->
			<el-form-item label="卖家账号" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.maijiazhanghao" autocomplete="off" placeholder="卖家账号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="卖家姓名" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.maijiaxingming" autocomplete="off" placeholder="卖家姓名" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">手机</div>
			...
			<el-form-item label="手机" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">邮箱</div>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210128/fdf3a4d8893247439257f6a546add599.jpg");
		height: 100vh;
