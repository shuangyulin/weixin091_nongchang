     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='maijia'"  label="卖家姓名" prop="maijiaxingming">
          <el-input v-model="ruleForm.maijiaxingming"               placeholder="卖家姓名" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='maijia'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
          ...
          <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
                ...
                :value="item">
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='maijia'"  label="手机" prop="shouji">
          <el-input v-model="ruleForm.shouji"               placeholder="手机" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='maijia'"  label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang"               placeholder="邮箱" clearable></el-input>
                        ...
                        <el-col :span="24">  
        <el-form-item v-if="flag=='maijia'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
...
export default {
  ...
  methods: {
        ...
        return
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            if( 'maijia' ==this.flag && this.ruleForm.shouji&&(!isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
