<template>
	<view class="content">
		...
		<view class="links">
            			            			            <view class="link-highlight" @tap="onRegisterTap('yonghu')" :style='{"color":"rgba(23, 152, 242, 1)","fontSize":"24rpx"}'>注册用户</view>
            <view>|</view>
                        			            <view class="link-highlight" @tap="onRegisterTap('maijia')" :style='{"color":"rgba(23, 152, 242, 1)","fontSize":"24rpx"}'>注册卖家</view>
            <view>|</view>
